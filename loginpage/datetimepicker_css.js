...
*/	
	//end time picker
	// Js Validation for date picker --Start--
	funcCalback = "function callback(id, datum) {";
//	funcCalback += "  var CalId = document.getElementById(id); if (datum=== 'undefined') { var d = new Date(); datum = d.getDate() + '/' +(d.getMonth()+1) + '/' + d.getFullYear(); } window.calDatum=datum;CalId.value=datum; alert(CalId.value); var today = new Date();	var dd = today.getDate(); var mm = today.getMonth()+1; var yyyy = today.getFullYear(); var currdate = dd+'-'+mm+'-'+yyyy; alert(currdate);";
	funcCalback += "  	var today = new Date(); var dd = today.getDate();  var mm = today.getMonth()+1;  var yyyy = today.getFullYear(); var TODAYDt  = dd+'-'+mm+'-'+yyyy; var CalId = document.getElementById(id); if (datum=== 'undefined') { var d = new Date(); datum = d.getDate() + '/' +(d.getMonth()+1) + '/' + d.getFullYear(); } window.calDatum=datum;CalId.value=datum; if((id == 'dob_f' || id == 'expdate') && parseInt(TODAYDt) > parseInt(datum)) { alert('Incorrect Date'); CalId.value = ''; }";
	...
	// Js Validation for date picker --End--
